...
func (tx *Tx) init() {
	...
	tx.CaddyIDMapping = NewCaddyIDMappingClient(tx.config)
	tx.ConfigSnapshot = NewConfigSnapshotClient(tx.config)
	tx.Domain = NewDomainClient(tx.config)
	tx.DomainShare = NewDomainShareClient(tx.config)
	tx.Invitation = NewInvitationClient(tx.config)
	tx.Project = NewProjectClient(tx.config)
	tx.ProjectAuditLog = NewProjectAuditLogClient(tx.config)
	tx.ProjectMember = NewProjectMemberClient(tx.config)
	tx.ProxyConfig = NewProxyConfigClient(tx.config)
