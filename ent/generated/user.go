...
type User struct {
	...
	// OauthSubject holds the value of the "oauth_subject" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldEmail, user.FieldPasswordHash, user.FieldStatus, user.FieldOauthProvider, user.FieldOauthSubject:
			values[i] = new(sql.NullString)
		case user.FieldEmailVerifiedAt, user.FieldLastLoginAt, user.FieldCreatedAt, user.FieldUpdatedAt:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldOauthSubject:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field oauth_subject", values[i])
			} else if value.Valid {
				_m.OauthSubject = value.String
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("oauth_subject=")
	builder.WriteString(_m.OauthSubject)
	builder.WriteString(", ")
