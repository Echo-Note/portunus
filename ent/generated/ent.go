...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			caddyidmapping.Table:  caddyidmapping.ValidColumn,
			configsnapshot.Table:  configsnapshot.ValidColumn,
			domain.Table:          domain.ValidColumn,
			domainshare.Table:     domainshare.ValidColumn,
			invitation.Table:      invitation.ValidColumn,
			project.Table:         project.ValidColumn,
			projectauditlog.Table: projectauditlog.ValidColumn,
			projectmember.Table:   projectmember.ValidColumn,
			proxyconfig.Table:     proxyconfig.ValidColumn,
