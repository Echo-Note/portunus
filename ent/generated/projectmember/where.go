...
func InvitedBy(v uuid.UUID) predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldEQ(FieldInvitedBy, v))
}
...
func InvitedByEQ(v uuid.UUID) predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldEQ(FieldInvitedBy, v))
}

// InvitedByNEQ applies the NEQ predicate on the "invited_by" field.
func InvitedByNEQ(v uuid.UUID) predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldNEQ(FieldInvitedBy, v))
}

// InvitedByIn applies the In predicate on the "invited_by" field.
func InvitedByIn(vs ...uuid.UUID) predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldIn(FieldInvitedBy, vs...))
}

// InvitedByNotIn applies the NotIn predicate on the "invited_by" field.
func InvitedByNotIn(vs ...uuid.UUID) predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldNotIn(FieldInvitedBy, vs...))
}

// InvitedByIsNil applies the IsNil predicate on the "invited_by" field.
func InvitedByIsNil() predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldIsNull(FieldInvitedBy))
}

// InvitedByNotNil applies the NotNil predicate on the "invited_by" field.
func InvitedByNotNil() predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldNotNull(FieldInvitedBy))
}
...
func JoinedAtIsNil() predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldIsNull(FieldJoinedAt))
}

// JoinedAtNotNil applies the NotNil predicate on the "joined_at" field.
func JoinedAtNotNil() predicate.ProjectMember {
	return predicate.ProjectMember(sql.FieldNotNull(FieldJoinedAt))
}
...
func HasInviter() predicate.ProjectMember {
	return predicate.ProjectMember(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasInviterWith(preds ...predicate.User) predicate.ProjectMember {
	return predicate.ProjectMember(func(s *sql.Selector) {
		step := newInviterStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
